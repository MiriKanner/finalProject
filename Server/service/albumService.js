...
import { getMyChildrenAlbumQuery, getParentChildRelationIdQuery, myAlbumsQuery } from "../queries/albumQueries.js";
...
export class AlbumService {
  ...
  async addChildAlbum(username, reqBody, imgSrc) {
    ...
    const parentChildId = getParentChildRelationIdQuery();
    const relationId = await executeQuery(parentChildId, [username, reqBody.childUserName]);
